...
export default function PipelineStepper({ role = "executive" }) {
    ...
    const executiveSteps = [
        ...
        { num: 6, title: "Completed", path: "/executive-completed-order", icon: "✅" },
    ];
    ...
    const mediatorSteps = [
        ...
        { num: 4, title: "Completed", path: "/mediator-completed-orders", icon: "✅" },
        { num: 5, title: "Return Refunds", path: "/mediator-pending-payment", icon: "💳" },
    ];
